...
function headerHTML(){
  return `
    ...
    <div class="logo-area" onclick="window.location.href='http://localhost:8082'" style="cursor:pointer; display: flex; align-items: center; gap: 14px; text-decoration: none;">
      <div class="logo-emblem-wrap" style="position: relative; width: 44px; height: 44px; border-radius: 10px; display: flex; align-items: center; justify-content: center; overflow: hidden; background: linear-gradient(135deg, #0f172a, #1e3a8a); border: 1px solid rgba(6, 182, 212, 0.3);">
          <img src="http://localhost:8082/images/isa-emblem.png" alt="ISA" class="logo-emblem-img" onerror="this.src='https://antigravity.google/favicon.ico'; this.onerror=null;" style="width: 80%; height: 80%; object-fit: contain;">
      </div>
      <div class="logo-text">
