...
function headerHTML(){
  return `
    <div id="gov-bar" style="display: flex; justify-content: center; gap: 20px; padding: 6px 0; background-color: #0b1120; border-bottom: 1px solid rgba(255,255,255,0.05); align-items: center; width: 100%;">
        <div class="gov-badge" style="display: flex; align-items: center; gap: 6px; opacity: 0.8; transition: opacity 0.3s ease;">
            <svg class="gov-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: 16px; height: 16px;">
            ...
            <span id="gov-culture" style="font-size: 11px; font-weight: 700; color: #e5e7eb; letter-spacing: -0.5px;">문화체육관광부</span>
        </div>
        <div class="gov-badge" style="display: flex; align-items: center; gap: 6px; opacity: 0.8; transition: opacity 0.3s ease;">
            <svg class="gov-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: 16px; height: 16px;">
            ...
            <span id="gov-coast" style="font-size: 11px; font-weight: 700; color: #e5e7eb; letter-spacing: -0.5px;">해양경찰청</span>
        </div>
    </div>
    <header class="header"><div class="header-inner">
    <div class="logo-area" onclick="window.location.href='/'" style="cursor:pointer; display: flex; align-items: center; gap: 12px; text-decoration: none;">
      <div class="logo-emblem-wrap" style="position: relative; width: 44px; height: 44px; background: rgba(15, 23, 42, 0.8); border-radius: 12px; display: flex; align-items: center; justify-content: center; overflow: hidden; box-shadow: 0 4px 15px rgba(6, 182, 212, 0.15); border: 1px solid rgba(6, 182, 212, 0.2);">
          <img src="/images/isa-emblem.png" alt="ISA" class="logo-emblem-img" onerror="this.src='../images/isa-emblem.png'; this.onerror=null;" style="width: 90%; height: 90%; object-fit: contain; z-index: 2;">
          <span class="logo-initial" style="position: absolute; bottom: -8px; left: 50%; transform: translateX(-50%); font-family: 'Orbitron', sans-serif; font-weight: 900; font-size: 16px; color: #06b6d4; text-shadow: 0 0 10px rgba(6, 182, 212, 0.8); z-index: 3; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.5)); letter-spacing: 1px;">ISA</span>
      </div>
      <div class="logo-text">
        <h1 style="margin:0;font-size:1.4rem;font-weight:900;letter-spacing:-0.5px;color:#fff;text-shadow:0 0 10px rgba(255,255,255,0.2);">국제인공서핑협회</h1>
        <p style="margin:2px 0 0;font-size:0.65rem;color:#06b6d4;font-family:'Orbitron',sans-serif;letter-spacing:1px;font-weight:700;">INTL ARTIFICIAL SURFING ASSOC.</p>
      </div>
    </div>
    <div style="display:flex;gap:10px;align-items:center;">
      <button class="header-badge" data-action="home" style="cursor:pointer;border:1px solid rgba(6,182,212,0.3);background:rgba(6,182,212,0.1);color:#22d3ee;">🛡️ 가입</button>
      <button class="header-badge" data-action="go-claim" style="cursor:pointer;">📋 청구</button>
    </div>
  </div></header>`;
}
